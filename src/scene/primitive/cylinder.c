...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/22 14:11:17 by dcortes           #+#    #+#             */
/*   Updated: 2024/08/22 14:11:17 by dcortes          ###   ########.ch       */
/*                                                                            */
/* ************************************************************************** */
...
t_vec4 v_axis, float diameter, float height)
{
    ...
    theta_x = atan2(v_axis.data[X], v_axis.data[Z]);
    theta_y = atan2(v_axis.data[Z], v_axis.data[Y]);
